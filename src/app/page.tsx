    ...
    <main className="min-h-screen bg-gray-50 p-8">
      ...
      {produtoSelecionado && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-4xl w-full p-6 relative overflow-y-auto max-h-[95vh]">
            <button 
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-sm font-semibold text-gray-600">Calcular Frete:</p>
                  ...
                  {frete && <p className="text-green-700 font-medium">🚚 Chega em 7 dias por R$ {frete.toFixed(2)}</p>}
                </div>

                <button 
                  onClick={handleFinalizarNoSite}
                  disabled={loading}
                  className="w-full bg-green-500 hover:bg-green-600 text-white text-xl font-bold py-4 rounded-xl shadow-lg transition-all"
                >
